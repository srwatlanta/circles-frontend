export function currentUser(history) {
  ...
  return dispatch => {
    ...
    return fetch("https://circles-backend.herokuapp.com/profile", reqObj)
      .then(res => res.json())
      .then(user => {
...
export function loginUser(data, history) {
  return dispatch => {
    ...
    return fetch("https://circles-backend.herokuapp.com/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export function fetchAllUsers() {
  ...
  return dispatch => {
    ...
    return fetch("https://circles-backend.herokuapp.com/users", reqObj)
      .then(res => res.json())
      .then(data => {
...
export function editUser(id, data) {
  ...
  return dispatch => {
    ...
    return fetch(`https://circles-backend.herokuapp.com/users/${id}`, reqObj)
      .then(res => res.json())
      .then(data => {
...
export function createUser(user, history) {
  ...
  return dispatch => {
    ...
    history.push("/login").then(fetchAllUsers());
  };
}
