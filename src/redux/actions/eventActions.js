export function fetchEvent(history, id) {
  ...
  return dispatch => {
    ...
    return fetch(`https://circles-backend.herokuapp.com/events/${id}`, reqObj)
      .then(res => res.json())
      .then(event => {
...
export function editEvent(id, data) {
  ...
  return dispatch => {
    ...
    return fetch(`https://circles-backend.herokuapp.com/events/${id}`, patchObj)
      .then(res => res.json())
      .then(event => {
        dispatch({ type: "EVENT_SET", event });
      });
...
export function createEvent(data, history) {
  ...
  return dispatch => {
    ...
    return fetch("https://circles-backend.herokuapp.com/events", reqObj)
      .then(res => res.json())
      .then(event => {
        dispatch({ type: "EVENT_SET", event });
...
export function createComment(comment, userId, eventId) {
  ...
  return dispatch => {
    ...
    return fetch("https://circles-backend.herokuapp.com/comments", reqObj)
      .then(res => res.json())
      .then(event => {
        dispatch({ type: "EVENT_SET", event });
      });
